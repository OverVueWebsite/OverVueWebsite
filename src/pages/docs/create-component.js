    ...
    <DocsLayout>
      <div className="docs__content">
        ...
        <div className="desc">
          ...
          <img className="gif" alt="create component" src={CreateComponentPic}></img>
        </div>
        <div className="desc">
          <div>
          ...
          <img className="gif" alt="element plus" src={CreateElementPlus}></img>
        </div>
        <div className="desc">
          <div>
          ...
          <img className="gif" alt="add class and more" src={AddingProps}></img>
        </div>
        <div className="desc">
          <div>
          ...
          <img className="gif" alt="component styling" src={Codesnippet}></img>
        </div>
      </div>
    </DocsLayout>
  );
